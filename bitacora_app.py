...
ACCION_KEYWORDS = [
    ("Trascribir", ("trascrib", "transcrib", "pasar a limpio", "dictad", "copiar texto",
                     "mecanograf", "pasar a digital", "audio a texto")),
    ("Tabular", ("tabul", "hoja de calculo", "hoja de cálculo", "en excel", "en csv", "cuadro de datos",
                 "planilla", "google sheets", "consolidar datos", "consolidado", "matriz de",
                 "vaciar informacion", "vaciar información")),
    ("Organizar", ("organiz", "organic", "orden", "clasific", "clasifiqu", "acomod", "archiv",
                   "seleccion de foto", "selección de foto", "descarte de foto",
                   "depurar", "depuracion", "depuración", "carpetas", "etiquetar", "categoriz")),
    ...
    ("LLamar", ("llam", "telefon", "por teléfono", "por telefono", "video llamada", "videollamada",
                "conferencia telefonica", "conferencia telefónica")),
    ("Enviar", ("envi", "mand", "remit", "despach", "correo a", "mensaje a", "compart",
                "public", "publiqu", "wsp a", "whatsapp a", "subir a redes", "posteo", "postear")),
    ("Reunir", ("reun", "junta", "cita con", "mesa de trabajo", "visita comercial",
                "visité al cliente", "visite al cliente", "call con", "comite", "comité",
                "capacitacion", "capacitación", "charla con")),
    ("Redactar", ("redact", "document", "elabora", "escrib", "preparar informe", "preparar documento",
                  ...
                  "carta a", "oficio", "acta de", "minuta",
                  "community manager", "periodista", "comunicador social")),
    ("Analizar", ("analiz", "analic", "análisis", "revis", "evalu", "verific", "verifiqu", "comprob", "chequ",
                  ...
                  "falla", "control de calidad", "seguimiento a indicadores", "indicadores", "kpi")),
    ...
    ("Gestionar", ("gestion", "gestión", "tramit", "coordin", "administr", "supervis", "manej", "seguimiento",
                   ...
                   "aportes", "incapacidad", "afiliacion", "afiliación", "eps", "arl",
                   "vacante", "reclutamiento", "hoja de vida", "hojas de vida",
                   "tesorer", "flujo de caja", "egresos", "transferencia", "renovacion", "renovación",
                   "poliza", "póliza",
                   ...
                   "coordinador de talento humano", "analista de recursos humanos",
                   "gerente de recursos humanos", "jefe de personal", "reclutador",
                   "psicologo organizacional", "psicólogo organizacional",
                   "auxiliar contable", "contador publico", "contador público", "analista financiero",
                   "gerente financiero", "coordinador de cartera", "analista de cartera", "revisor fiscal",
                   "gerente general", "subgerente", "director", "secretaria", "recepcionista",
                   "asistente ejecutiv",
                   "coordinador logistico", "coordinador logístico", "jefe de operaciones",
                   ...
                   "coordinador sst", "tecnico en salud ocupacional", "técnico en salud ocupacional")),
    ("Extraer", ("extrac", "extraer", "extraj", "descarg", "recopil", "sacar informacion", "sacar información",
                 "consultar base de datos", "buscar informacion", "buscar información", "obtener datos")),
    ("Digitar", ("digit", "captur", "ingres", "registr", "carg", "aliment", "actualiz", "actualic",
                 "subi", "subí", "factur", "asiento contable", "diligenciar", "llenar formulario")),
    ("Desarrollar", ("desarroll", "programa", "constru", "crear", "cree ", "creé",
                      ...
                      "cubrir evento", "cobertura", "aplicacion", "aplicación", "automatizacion",
                      "automatización", "pagina web", "página web", "video edicion", "video edición",
                      "montaje",
                      "ingeniero de sistemas", "ingeniero de software", "analista de sistemas",
                      "arquitecto de software", "administrador de bases de datos", "dba",
                      "diseñador ux", "diseñador ui", "editor de video", "editor multimedia")),
    ("Estructurar", ("estructur", "armar formato", "definir estructura", "defin", "esquemat", "diseñar formato",
                      "plane", "planific", "cronograma", "hito", "roadmap", "plan de trabajo",
                      "flujo de proceso", "procedimiento")),
]
